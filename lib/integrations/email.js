...
class EmailIntegration {
  constructor(options = {}) {
    ...
    this.from = options.from || getConfigValue('EMAIL_FROM', 'noreply@beast-mode.dev');
    this.config = {
      smtp: {
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="footer">
              <p>Powered by <a href="https://beast-mode.dev">BEAST MODE</a> - AI-Powered Development Tools</p>
            </div>
          </div>
        </div>
      </body>
