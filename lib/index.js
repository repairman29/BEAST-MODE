...
class BeastMode {
        ...
        try {
            ...
            if (this.options.janitor !== false) {
                ...
                if (!hasDay2Ops && this.subscriptionTier === 'free') {
                    ...
                    log.info('💡 Upgrade at https://beastmode.dev/pricing to unlock Day 2 Operations');
    ...
    async predict(options = {}) {
        ...
        if (!this.hasFeature('advanced-analytics') && this.subscriptionTier === 'free') {
            throw new Error('Predictive analytics requires Developer tier or higher. Upgrade at https://beastmode.dev/pricing');
        }
