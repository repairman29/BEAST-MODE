...
/**
 * Navigate definition (mouse)
 * 
 * Generated from user story: US-0186
 * Category: Core Coding - Navigation
 * 
 * As: a developer
 * Want: to navigate definition using mouse
 * So That: so that I can find code quickly
 */

import { useState } from 'react';

interface US_0186Props {
  // Add props as needed
}

export default function US_0186(props: US_0186Props) {
    ...
    return (
      <div className="p-4 bg-slate-800 rounded-lg border border-slate-700">
        ...
        <p className="text-sm text-slate-300 mb-4">
          to navigate definition using mouse
        </p>
