...
/**
 * Navigate reference (mouse)
 * 
 * Generated from user story: US-0190
 * Category: Core Coding - Navigation
 * 
 * As: a developer
 * Want: to navigate reference using mouse
 * So That: so that I can find code quickly
 */

import { useState } from 'react';

interface US_0190Props {
  // Add props as needed
}

export default function US_0190(props: US_0190Props) {
    ...
    return (
      <div className="p-4 bg-slate-800 rounded-lg border border-slate-700">
        ...
        <p className="text-sm text-slate-300 mb-4">
          to navigate reference using mouse
        </p>
