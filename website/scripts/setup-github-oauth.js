...
const NEXT_PUBLIC_URL = process.env.NEXT_PUBLIC_URL || 'http://localhost:7777';
...
async function setupSupabase() {
  ...
  try {
    ...
    if (checkError && checkError.code === 'PGRST116') {
      console.log('📋 Creating app_config table in Supabase...');
...
`;
  ...
  try {
    ...
    console.log('✅ Updated .env.local with GitHub OAuth credentials');
    return true;
  } catch (error) {
...
async function main() {
  console.log('🚀 Setting up GitHub OAuth Configuration...\n');
